...
function EquipmentSvg({ id }: { id: EquipmentId }) {
  switch (id) {
    ...
    case 'two-tees':
      return (
        <svg viewBox="0 0 24 24" width="18" height="18">
          <line x1="8" y1="7" x2="8" y2="19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <circle cx="8" cy="6" r="2.5" fill="currentColor" />
          <line x1="16" y1="7" x2="16" y2="19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
