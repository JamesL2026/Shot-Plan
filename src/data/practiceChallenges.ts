  ...
  'hook-grip-check': [
    {
      ...
      templateLabel: 'Ball Flight Control',
      estimatedMinutes: 5,
      objective: 'Keep a quieter face so the ball does not curve left early.',
      practice: [
        'Point the face at the target before you grip.',
        'Set two knuckles on the lead hand. Leave them.',
        'Hit eight smooth shots. Watch the start, not the curve.',
        'If the face wants to shut, reset the grip completely.',
      ],
      successCondition: 'Seven of eight starts look calmer and closer to your line.',
      reflection: 'Did a quieter grip calm the start of the ball?',
    },
    {
      id: 'hook-grip-consistency',
      template: 'consistency',
      templateLabel: 'Consistency',
      estimatedMinutes: 4,
      objective: 'Repeat the same neutral grip without twisting the face closed.',
      practice: [
        'Face first. Hands second. Same every time.',
        'Hit six shots with a full grip reset between each one.',
        'Only count shots where you still see two knuckles at address.',
        'Finish with four swings without changing anything mid-setup.',
      ],
      successCondition: 'Eight successful repetitions with the same grip look.',
      reflection: 'Did resetting each time make the grip feel more honest?',
    },
    {
      id: 'hook-grip-pressure',
      template: 'pressure',
      templateLabel: 'Pressure Challenge',
      estimatedMinutes: 4,
      objective: 'Hold the quiet grip through a short finishing streak.',
      practice: [
        'Set the grip once. Confirm two knuckles.',
        'Hit two warmups.',
        'Make three good starts in a row without regripping mid-swing.',
        'Miss? Reset the grip and restart the streak.',
      ],
      successCondition: 'Three consecutive calm starts with the same grip.',
      reflection: 'Could you keep the face quiet when it counted?',
    },
  ],
