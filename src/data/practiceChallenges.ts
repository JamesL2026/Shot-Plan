  ...
  'hook-split-hand': [
    {
      ...
      templateLabel: 'Pressure Challenge',
      estimatedMinutes: 5,
      objective: 'Keep a quiet face with a split grip under a restart rule.',
      practice: [
      ...
      successCondition: 'Five consecutive quiet-face half swings with a split grip.',
    ...
    },
    {
      ...
      templateLabel: 'Consistency',
      estimatedMinutes: 6,
      objective: 'Repeat a soft-face feel with hands separated on the grip.',
      practice: [
        'Set the split grip once and keep it.',
        'Hit smooth half swings only.',
        'Only count swings where the face feels quiet through the ball.',
        'Stay patient. No steering.',
      ],
      successCondition: 'Eight successful quiet-face repetitions.',
    ...
    },
    {
      ...
      successCondition: 'Start 6 of 8 near your line with a quiet face.',
